...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollUpButton
    ref={ref}
    className={cn(
      "sticky top-0 z-10 flex cursor-default items-center justify-center gap-1 border-b bg-popover px-3 py-1.5 text-[10px] text-muted-foreground",
      className,
    )}
    {...props}
  >
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollDownButton
    ref={ref}
    className={cn(
      "sticky bottom-0 z-10 flex cursor-default items-center justify-center gap-1 border-t bg-popover px-3 py-1.5 text-[10px] text-muted-foreground",
      className,
    )}
    {...props}
  >
